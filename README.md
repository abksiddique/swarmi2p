...
| ------------------------------------------------ | --------------------------------------------------------------------- | ------------------------------------------------------------------------------------------ | ---------------------------------------- | ------------------------------------------------------------------------------- |
| **Fig. 4 — Exploratory (Tunnel)**         | Selection frequency & time trend                                      | `Exploratory%20Tunnel-merged.txt                                   | `notebooks/Exploratory_Tunnels.ipynb`          | `docs/figures/fig4_Exploratorytunnel.jpg`, `docs/figures/fig5_fastset_timeline.png` |
